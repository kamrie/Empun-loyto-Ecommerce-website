...
if(isset($_POST['update_images'])){
    ...
    $stmt = $conn->prepare('UPDATE products SET product_image=?, product_image2=?, product_image3=?, product_image4=?
                         WHERE product_id=?');
    ...
    if($stmt->execute()){
        ...
        header('location: products.php?Image_failed=Error occurred, try again');
    }
}
?>